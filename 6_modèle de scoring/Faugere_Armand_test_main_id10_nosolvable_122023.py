...
# test du retour NO SOLVABLE client sur client index 10
def test_classifier():
    response = client.post('/predict', json = {'ID_CLIENT' : 10})
    assert response.json() == {'label' : [1], 'probability' : [0.8479179551542885]}
